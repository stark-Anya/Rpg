...
from handlers.economy import bal, daily, claim, mine, farm, crime, give, transfer, toprich
from handlers.rpg import kill, rob, protect, revive, heal, hp, profile, topkill, ranking
...
def main():
    ...
    app.add_handler(CallbackQueryHandler(propose_button_handler, pattern="^propose_"))
