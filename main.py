...
#=============== OWNER : MISTER STARK ==============#
#===================================================#
#==== MAIN FILE : WHERE HANDLERS ARE INSTALLED======#
#===================================================#
...
from handlers.shop import shop, shop_button_handler, sell, sell_button_handler
...
def main():
    ...
    app.add_handler(CallbackQueryHandler(sell_button_handler,    pattern="^sell_"))
